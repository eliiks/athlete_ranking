...
class AthleteFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $athlete1->setClubId($club[0]);
        $athlete1->setCategorieId($cat[0]);
        ...
        $athlete2->setClubId($club[0]);
        $athlete2->setCategorieId($cat[0]);
        ...
        $athlete3->setClubId($club[0]);
        $athlete3->setCategorieId($cat[0]);
        ...
        $athlete4->setClubId($club[0]);
        $athlete4->setCategorieId($cat[0]);
        ...
        $athlete5->setClubId($club[0]);
        $athlete5->setCategorieId($cat[0]);
        ...
        $athlete6->setClubId($club[0]);
        $athlete6->setCategorieId($cat[0]);
